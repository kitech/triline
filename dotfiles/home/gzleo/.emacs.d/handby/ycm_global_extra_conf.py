...
def YcmCorePreload():
    print("TODO need impled:", __file__)
    flags.append('-isystem')
    flags.append('/usr/include/qt/')
    flags.append('-isystem')
    flags.append('/usr/include/qt/QtCore')
    flags.append('-isystem')
    flags.append('/usr/include/qt/QtGui')
    flags.append('-isystem')
    flags.append('/usr/include/qt/QtWidgets')
    flags.append('-isystem')
